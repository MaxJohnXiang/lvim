...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'dial.nvim', 'gitlinker.nvim', 'hop.nvim', 'numb.nvim', 'Comment.nvim', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
